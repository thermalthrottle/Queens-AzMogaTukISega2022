...
\___,_\ \__,_|\___|\___|_| |_|___/
        ...
        public PlayerVSPlayerView()
        {
            ...
            int[] dimensions = BoardInputValidator.BoardInputValidator.GetBoardSize();
        ...
        public void BoardCycle()
        {
            while (true)
            {
                ...
                BoardOutput.BoardOutput.BoardToString(_playerBoard);
                int[] cord = BoardInputValidator.BoardInputValidator.GetPlayerInputCord(playerOneTurn,out endEarly,_playerBoard);
                if (endEarly) {
                    break;
                };
                int x = cord[0];
